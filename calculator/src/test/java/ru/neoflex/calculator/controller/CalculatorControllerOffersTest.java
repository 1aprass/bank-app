...
public class CalculatorControllerOffersTest {
    ...
    void calculateOffersSuccess() throws Exception{
        ...
        when(calculatorService.calculateOffers(any(LoanStatementRequestDto.class))).thenReturn(response);
        ...
        verify(calculatorService, times(1)).calculateOffers(any(LoanStatementRequestDto.class));

    }

    @Test
    void calculateOffers_InvalidJson_ShouldReturnBadRequest() throws Exception {
    ...
    void calculateOffers_ServiceThrowsIllegalArgument_ShouldReturnBadRequest() throws Exception {
        ...
        when(calculatorService.calculateOffers(any()))
        ...
        verify(calculatorService, times(1)).calculateOffers(any());
    }

    @Test
    void calculateOffers_ServiceThrowsException_ShouldReturnInternalServerError() throws Exception {
